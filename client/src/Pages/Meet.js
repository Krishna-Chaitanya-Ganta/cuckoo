...
function Meet (props) {
  ...
  // mounted hook where will establish the initial connection
  useEffect(() => {
  ...
  //       peer.on("signal", data => {
  //         socket.current.emit("callUser", { userToCall: "", signalData: data, from: "yourID" })
  //       })
